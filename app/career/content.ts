...
export type PhaseKey = "ux" | "motion" | "product" | "pm" | "dev" | "founder" | "builder"
...
> = {
  ...
  builder: { color: "#60A5FA", bg: "rgba(96,165,250,0.06)", border: "rgba(96,165,250,0.15)", hoverBg: "rgba(96,165,250,0.1)", hoverBorder: "rgba(96,165,250,0.3)" },
}
...
export const TIMELINE: TimelineRow[] = [
  {
    ...
    boxes: [
      { phase: "ux", flex: 1, shortName: "UX Designer", shortOpacity: 0.6, shortFontSize: "0.85rem",
        label: "Phase 01", title: "UX Designer",
  ...
  },
  {
    ...
    boxes: [
      ...
      { phase: "motion", flex: 1, shortName: "Brand & Motion Designer", shortOpacity: 0.6, shortFontSize: "0.85rem",
        label: "Phase 02", title: "Brand & Motion Designer",
        companies: "1mg",
  ...
  },
  {
    ...
    boxes: [
      { phase: "ux",     flex: 1, shortName: "UX",     shortOpacity: 0.4, shortFontSize: "0.8rem" },
      { phase: "motion", flex: 1, shortName: "Brand & Motion Designer", shortOpacity: 0.4, shortFontSize: "0.8rem" },
      { phase: "product", flex: 1, shortName: "Product Designer", shortOpacity: 0.6, shortFontSize: "0.85rem",
        label: "Phase 03", title: "Product Designer",
  ...
  },
  {
    ...
    boxes: [
      { phase: "ux",      flex: 1, shortName: "UX",            shortOpacity: 0.35, shortFontSize: "0.75rem" },
      { phase: "motion",  flex: 1, shortName: "Brand + Motion Designer",        shortOpacity: 0.35, shortFontSize: "0.75rem" },
      { phase: "product", flex: 1, shortName: "Product Design", shortOpacity: 0.35, shortFontSize: "0.75rem" },
      { phase: "pm", flex: 1, shortName: "Product Designer + Product Manager", shortOpacity: 0.6, shortFontSize: "0.85rem",
        label: "Phase 04", title: "Product Designer + Product Manager",
  ...
  },
  {
    ...
    boxes: [
      { phase: "ux",      flex: 1, shortName: "UX",      shortOpacity: 0.25, shortFontSize: "0.65rem" },
      { phase: "motion",  flex: 1, shortName: "Brand + Motion Designer",  shortOpacity: 0.25, shortFontSize: "0.65rem" },
      { phase: "product", flex: 1, shortName: "Product Design", shortOpacity: 0.25, shortFontSize: "0.65rem" },
