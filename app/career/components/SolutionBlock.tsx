...
export function SolutionBlock() {
  return (
    <div className="py-12 relative" style={{ borderTop: "1px solid var(--career-subtle-border)" }}>
      <Reveal>
        <p
      ...
      <Reveal delay={0.25}>
        <p
          ...
          style={{ fontSize: "1rem", color: "var(--career-text-secondary)" }}
        >
      ...
      <div className="flex flex-col gap-6">
        {SOLUTION_UNITS.map((unit, i) => (
          <Reveal key={i} delay={i * 0.1}>
            <motion.div
              className="relative rounded-xl overflow-hidden backdrop-blur-3xl"
              style={{ background: "var(--career-backdrop-bg)", border: "1px solid var(--career-card-border)" }}
            ...
            >
              ...
              <div className="grid md:grid-cols-[80px_1fr] gap-6 p-6">
                ...
                <div>
                  ...
                  <p className="text-[0.8rem] leading-relaxed mb-3" style={{ color: "var(--career-text-muted)" }}>
                    {unit.problem}
                  </p>
                  <p className="text-[0.85rem] leading-relaxed mb-4" style={{ color: "var(--career-text-secondary)" }}>
                    {unit.solution}
                  </p>
                  <span
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-3">
                    {unit.tools.map((t) => (
                      <span
                        ...
                        style={{ background: "var(--career-subtle-bg)", color: "var(--career-text-muted)" }}
                      >
                        {t}
                      </span>
                    ))}
      ...
      <Reveal delay={0.3}>
        <div
          ...
          style={{ background: "var(--career-card-bg)", border: "1px solid var(--career-card-border)", padding: "3rem" }}
        >
          <div
            className="absolute top-0 left-0 right-0 h-0.5"
            style={{ background: "linear-gradient(to right, #4ECDC4, #A78BFA, #F472B6)" }}
          />
          <p className="text-[0.6rem] tracking-[0.3em] uppercase mb-6" style={{ color: "var(--career-text-muted)" }}>
            The Vision
          </p>
          <p
            className="font-serif italic leading-relaxed mx-auto mb-6 max-w-[640px]"
            style={{ fontSize: "clamp(1.3rem, 2.5vw, 1.8rem)", color: "var(--career-text)" }}
          >
          ...
          <p className="text-[0.75rem] tracking-[0.1em]" style={{ color: "var(--career-text-muted)" }}>
