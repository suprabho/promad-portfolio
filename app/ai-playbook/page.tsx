    ...
    <div className="min-h-screen bg-background">
      ...
      <Section id="design-system">
        ...
        >
          <LinkCard
            ...
            description="Transform color groups into semantic tokens. Create new collections, duplicate with remapping, update values across libraries."
            href="https://www.figma.com/community/plugin/1570424472381396729/cross-collection-color-token-mapper"
          />
          <LinkCard
            icon={CursorClick}
            title="Variant Selector"
            description="Filter variants by properties and select in bulk. Handle complex component sets with hundreds of variants."
            ...
            <Card className="h-full">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3 pt-2">
                  <ProcessStep number={1} title="Creative brief input" />
                  <ProcessStep number={2} title="AI generates modular script components" delay={0.1} />
                  <ProcessStep number={3} title="Separate screenplay options for visuals" delay={0.2} />
                  <ProcessStep number={4} title="Mix-and-match any combination" delay={0.3} />
                </div>
              </CardContent>
            </Card>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  From concept to shoot-ready documentation
                </CardDescription>
              </CardHeader>
              <CardContent>
                <motion.div
      ...
      <Section id="shipping">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="inline-flex items-baseline gap-3">
              <span className="font-mono font-extrabold text-6xl md:text-8xl">
                <AnimatedCounter target={1026} duration={2.5} />
              </span>
          ...
          >
            <StatBar repo="flp-web" commits={848} added="35,579" removed="15,460" maxCommits={848} />
            <StatBar repo="kidzovo-website" commits={76} added="2,388" removed="547" maxCommits={848} />
            <StatBar repo="kidzovo-flutter-ui" commits={71} added="880" removed="315" maxCommits={848} />
            <StatBar repo="kidzovo-creator-studio" commits={31} added="1,267" removed="1,020" maxCommits={848} />
          </motion.div>
          ...
          >
            <div className="text-center">
              <div className="font-mono text-3xl md:text-4xl font-bold text-green-500">
                +<AnimatedCounter target={40114} duration={2} />
              </div>
            ...
            <div className="text-center">
              <div className="font-mono text-3xl md:text-4xl font-bold text-red-400">
                -<AnimatedCounter target={17342} duration={2} />
              </div>
